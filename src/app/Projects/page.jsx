...
export default function ProjectsSection() {
  ...
  return (
    <main>
      ...
      >
        <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4 mb-12 sm:mb-24 text-center">
          {headingWords.map((word, i) => (
            <motion.h2
              ...
              whileInView="visible"
              viewport={{ once: true }}
              className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-pink-600 tracking-wide"
            >
              {word}
            </motion.h2>
          ))}
...
function ProjectItem({ image, link, label }) {
  return (
    ...
    >
      <div className="w-full h-52 sm:h-64 md:h-72 relative rounded-xl overflow-hidden mb-4">
        <Image
          src={image}
          alt={label}
          fill
